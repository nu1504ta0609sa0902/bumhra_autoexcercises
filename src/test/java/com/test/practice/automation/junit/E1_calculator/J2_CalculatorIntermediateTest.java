 ...
 */
public class J2_CalculatorIntermediateTest {

    /**
     * @Todo Aim: Create setup methods using the annotation @Before
     *
    ...
    /**
     * @Todo Aim: Create tearDown methods using the annotation @After
     *
